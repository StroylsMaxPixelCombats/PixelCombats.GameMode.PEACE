...
// Задаём в контекст инвентаря, пустой инвентарь
...
// Задаём опции режима мир, выбранные при создании, комнаты
